    ...
    public function ajax()
    {
        ...
        ->addColumn('action', function ($row) {
            ...
            if (auth()->user()->can('users.edit')) {
                $html .= '<li><a href="' . route('users.edit', encrypt($row->id)) . '"> Edit </a></li>';
            }
            if (auth()->user()->can('users.destroy')) {
                if ($row->id != auth()->user()->id) {
                    $html .= '<li><a id="deleteRow" data-row-route="' . route('users.destroy', $row->id) . '" href="' . route('users.destroy', encrypt($row->id)) . '"> Delete </a></li>';
                }
            }
            if (auth()->user()->can('users.show')) {
                $html .= '<li><a href="' . route('users.show', encrypt($row->id)) . '"> Show </a></li>';
            }
            $html .= '</ul>';
            return $html;
        })
