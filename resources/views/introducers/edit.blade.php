...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="sub-title">
                <h2>Edit Introducer</h2>
            </div>
            <div class="card-body">
                <form id="introducerForm" method="POST" action="{{ route('introducers.update', encrypt($introducer->id)) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-5">
                        ...
                        <div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="type" id="section-a-1-entity" value="Entity" {{ old('type', $introducer->type) == 'entity' ? 'checked' : '' }}>
                                <label class="form-check-label" for="section-a-1-entity">Entity</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="type" id="section-a-1-individual" value="Individual" {{ old('type', $introducer->type) == 'individual' ? 'checked' : '' }}>
                    ...
                    <div class="mb-5">
                        <div class="row {{ old('type', $introducer->type) == 'entity' ? '' : 'd-none' }}" id="s1ss1ent">
                            ...
                            <input type="text" class="form-control" name="full_name" placeholder="Please enter full name" value="{{ old('full_name', $introducer->name) }}">
                        </div>
                        <div class="row {{ old('type', $introducer->type) == 'Individual' ? '' : 'd-none' }}" id="s1ss1ind">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="First Name" value="{{ old('name', $introducer->name) }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-bold">  <span> Middle Name </span>  </label>
                                <input type="text" class="form-control" name="middle_name" placeholder="Middle Name" value="{{ old('middle_name', $introducer->middle_name) }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-bold">  <span> Last Name </span>  </label>
                                <input type="text" class="form-control" name="last_name" placeholder="Last Name" value="{{ old('last_name', $introducer->last_name) }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-5 row">
                        <div class=" col-lg-12 col-md-12 col-xl-6">
                            ...
                            <input type="email" class="form-control" name="email" placeholder="Please enter email address" value="{{ old('email', $introducer->email) }}">
                        </div>
                        <div class="col-lg-12 col-md-12 col-xl-6">
                            <label class="form-label fw-bold">Contact Number  </label>
                            <input type="hidden" id="section-a-1-dial_code" name="dial_code" value="{{ old('dial_code', $introducer->dial_code) }}">
                            <input type="tel" class="form-control" name="contact_number" id="section-a-1-phone_number" value="{{ old('contact_number', $introducer->contact_number) }}">
                        </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary">Update Introducer</button>
...
$(document).ready(function() {
    ...
    $('#introducerForm').validate({
        rules: {
            ...
            name: {
                required: function() { return $('input[name="type"]:checked').val() === 'Entity' ? false : ($('input[name="type"]:checked').val() === 'Individual'); }
            },
            middle_name: {
