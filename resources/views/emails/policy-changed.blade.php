...
<body>
    <div class="email-container">
        <div class="header">
            ...
            <p>Policy has been changed</p>
        </div>
        
        <div class="content">
            <p>Hello {{ $user->name }},</p>
            
            <p>Policy has been changed and requires your attention. Please review the details below:</p>
            ...
            <div class="policy-info">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ isset($details['title']) ? $details['title'] : '-' }}</span>
                </div>
                <div class="info-row">
