<form id="form-section-a-2" class="k-pro">
    <div class="key-parties-container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xl-6 col-lg-6 col-xxl-9">
                                ...
                                <div class="entity-name-field" style="@if($kr['entity_type'] == 'individual') display: none; @endif">
                                    ...
                                    <input type="text" class="form-control" name="policy_holder[{{ $loop->iteration - 1 }}][name]" value="{{ $kr['name'] ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4">
                ...
                <div class="insured-life-item mb-3 p-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xl-6 col-lg-6 col-xxl-9">
                            ...
                            <div class="entity-name-field" style="@if($kr['entity_type'] == 'individual') display: none; @endif">
                                <label class="form-label">Name</label>
                                <input type="text" class="form-control" name="insured_life[{{ $loop->iteration }}][name]" value="{{ $kr['name'] ?? '' }}">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                ...
                <div class="beneficiary-item mb-3 p-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xl-6 col-lg-6 col-xxl-9">
                            ...
                            <div class="entity-name-field" style="@if($kr['entity_type'] == 'individual') display: none; @endif">
                                <label class="form-label">Name</label>
                                <input type="text" class="form-control" name="beneficiary[{{ $loop->iteration }}][name]" value="{{ $kr['name'] ?? '' }}">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
        ...
        <div class="role-section mb-4">
            ...
            <div class="advisor-container" style="{{ ($invAdvManExistsApplicable ? 'applicable' : '') == 'not_applicable' ? 'opacity: 0.5; pointer-events: none;' : '' }}">
        ...
        <div class="role-section mb-4">
            ...
            <div class="idf-container" style="{{ ($idfApplicable ? 'applicable' : '') == 'not_applicable' ? 'opacity: 0.5; pointer-events: none;' : '' }}">
        ...
        <div class="role-section mb-4">
            ...
            <div class="idf-manager-container" style="{{ ($idfMgrApplicable ? 'applicable' : '') == 'not_applicable' ? 'opacity: 0.5; pointer-events: none;' : '' }}">
        ...
        <div class="role-section mb-4">
            ...
            <div class="custodian-container" style="{{ ($custodianApplicable ? 'applicable' : '') == 'not_applicable' ? 'opacity: 0.5; pointer-events: none;' : '' }}">
