<form id="form-section-f-6" class="case-premeim">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <input type="checkbox" id="f6c1" name="a[included]" class="form-check-input parent-checkbox check-main" value="yes" @if(($a['included'] ?? '') == 'yes') checked @endif>
                            <label for="f6c1"> </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <input type="checkbox" name="b[included]" id="f6c2" class="form-check-input parent-checkbox check-main" value="yes" @if(($b['included'] ?? '') == 'yes') checked @endif>
                            <label for="f6c2"> </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <input type="checkbox" name="c[included]" id="f6c3" class="form-check-input parent-checkbox check-main" value="yes" @if(($c['included'] ?? '') == 'yes') checked @endif>
                            <label for="f6c3"> </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <input type="checkbox" name="d[included]" id="f6c4" class="form-check-input parent-checkbox check-main" value="yes" @if(($d['included'] ?? '') == 'yes') checked @endif>
                            <label for="f6c4"> </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <input type="checkbox" name="e[included]" id="f6c5" class="form-check-input parent-checkbox check-main" value="yes" @if(($e['included'] ?? '') == 'yes') checked @endif>
                            <label for="f6c5"> </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <input type="checkbox" id="f6c6" name="f[included]" class="form-check-input parent-checkbox check-main" value="yes" @if(($f['included'] ?? '') == 'yes') checked @endif>
                            <label for="f6c6"> </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <input type="checkbox" id="f6c7" name="g[included]" class="form-check-input parent-checkbox check-main" value="yes" @if(($g['included'] ?? '') == 'yes') checked @endif>
                            <label for="f6c7"> </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <input type="checkbox" name="h[included]" id="f6c8" class="form-check-input parent-checkbox check-main" value="yes" @if(($h['included'] ?? '') == 'yes') checked @endif>
                            <label for="f6c8"> </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <input type="checkbox" name="i[included]" id="f6c9" class="form-check-input parent-checkbox check-main" value="yes" @if(($i['included'] ?? '') == 'yes') checked @endif>
                            <label for="f6c9"> </label>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <input type="checkbox" name="j[included]" id="f6c10" class="form-check-input parent-checkbox check-main" value="yes" @if(($j['included'] ?? '') == 'yes') checked @endif>
                            <label for="f6c10"> </label>
                        </td>
