                        ...
                        <div class="col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <input type="checkbox" name="permissions[]" data-parent="{{ Str::slug($key) }}" class="check-main" id="{{ $row->name }}" value="{{ $row->id }}" @if(in_array($row->id, $existingPermissions)) checked @endif disabled>
